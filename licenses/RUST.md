...
Inventario da Cargo.lock: include anche dipendenze di build e piattaforme diverse. I testi delle licenze sono nelle sottocartelle `rust/`.

| Crate | Versione | Licenza dichiarata |
| --- | --- | --- |
